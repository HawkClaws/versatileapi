...
class Test_ODataApi {
	...
	void OData_正常() {
		...
		assertTrue(Test_Helper.jsonEquals(gson.toJson(response1[0]), gson.toJson(response2[0])));
		...
		assertTrue(Test_Helper.jsonEquals(gson.toJson(response1[0]),
				gson.toJson(testJsonList.get("e4c98da0-5c61-492f-8eba-5b8a65c2f326"))));
		assertTrue(Test_Helper.jsonEquals(gson.toJson(response1[1]),
